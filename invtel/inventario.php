...
<html lang="en" width="100%" height="100%">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>Inventario de telefonos </title>
...
echo $_SESSION['usuario']['nombre']. "";
    ...
    <div class="container-fluid">
		...
		<div class='col-xs-10'>	
			<h3> Listado de Inventario de Telefonos</h3>
		...
		<div class='col-xs-5'>
			...
			<a href="../exportartel.php" class="btn btn-default">exportar</a>
			</h3>
		</div>
<!--		
		<div class='col-xs-14'>
...
<script src="../js/inventariostelefonos.js"></script>
	<script>
